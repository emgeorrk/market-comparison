...
Локальный воспроизводимый дашборд для сравнения рынков недвижимости шести стран, валют и фондовых индексов. В наборе 312 последовательных месяцев, 19 выбираемых показателей и три вспомогательных валютных ряда.
...
4. Нажимайте на показатели в четырёх группах, чтобы добавлять и убирать линии. При открытии выбраны только «Москва, вторичка», S&P 500 и Индекс Мосбиржи; хотя бы один ряд всегда остаётся на графике.
...
- `data/monthly_prices.csv` — месяцы, тип наблюдения недвижимости и 22 числовых ряда в родных единицах: 19 пользовательских показателей и три вспомогательных курса.
